...
public class JwtTokenUtil implements Serializable {
	...
	private static final long serialVersionUID = -42195701907913450L;
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        String token = Jwts.builder()
            ...
            .compact();
        //Add token to DB
        Optional<User> user = Optional.ofNullable(userRepository.findOne(subject));
    ...
    public void invalidateToken(String username) {
        ...
        Optional<User> user = Optional.ofNullable(userRepository.findOne(username));
        user.get().setToken("");
        userRepository.save(user.get());
    }
